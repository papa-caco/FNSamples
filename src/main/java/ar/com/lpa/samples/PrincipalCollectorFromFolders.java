...
public class PrincipalCollectorFromFolders 
{
	private static final Logger logger = Logger.getLogger(PrincipalCollectorFromFolders.class);
	...
	public static void main(String[] args) throws IOException 
	{
		...
		PrincipalCollectorFromFolders.p8realm.getP8domain().getP8connection().setCeURI(configLoader.getProperty("ceURI"));
		PrincipalCollectorFromFolders.p8realm.getP8domain().getP8connection().setUserName(configLoader.getProperty("userName"));
		PrincipalCollectorFromFolders.p8realm.getP8domain().getP8connection().setPassword(configLoader.getProperty("password"));
		...
		//getDocumentsPermissions("objst1");
